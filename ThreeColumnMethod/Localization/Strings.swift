...
enum Strings {
    ...
    static let en: [String: String] = [
        ...
        "distortion_mind_reading_label": "Jumping to Conclusions",
        "distortion_mind_reading_desc": "You jump to a negative conclusion without solid evidence for it — assuming you know what someone else is thinking (mind reading), or predicting that things will turn out badly and treating that prediction as if it were already a fact (fortune telling).",
    ...
    static let zh: [String: String] = [
        ...
        "distortion_mind_reading_label": "妄下结论",
        "distortion_mind_reading_desc": "你在没有确凿依据的情况下就妄下负面结论——可能是认定自己知道别人在想什么（臆测人心），也可能是预测事情将会有糟糕的结局，并把这个预测当成已经发生的事实来对待（未卜先知）。",
